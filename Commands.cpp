...
void ExternalCommand::execute() {
  ...
  {
  case 1:
    execl(command, string(args[0]), string(args[1]), (char*)NULL);
    break;
  case 2:
    execl(command, string(args[0]), string(args[1]), string(args[2]), (char*)NULL);
    break;
  default:
    execl(command, string(args[0]), (char*)NULL);
    break;
  }
}